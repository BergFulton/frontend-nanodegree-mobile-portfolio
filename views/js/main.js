    ...
    switch (x) {
        case "dark":
            var dark = ["dark", "morbid", "scary", "spooky", "gothic", "deviant", 
                ...
                "somber", "dark", "gloomy", "homicidal", "murderous", "shady", "misty",
        ...
        case "whimsical":
            ...
            "weird", "strange", "odd", "playful", "clever", "boastful", "breakdancing",
                ...
                "smiling", "perplexed", "baffled", "cockamamie", "vulgar", "hoodwinked",
                "brainwashed"
            ];
            return whimsy;
        ...
        case "noisy":
            ...
            "musical", "operatic", "symphonic", "dancing", "lyrical", "harmonic",
        ...
        case "apocalyptic":
            ...
            "zombie", "collapsed", "grim", "fallen", "collapsed", "cannibalistic",
                "radioactive", "toxic", "poisonous", "venomous", "disastrous", 
                "grimy", "dirty", "undead", "bloodshot", "rusty", "glowing", "decaying",
        ...
        case "insulting":
            ...
            "grotesque", "dull", "dumb", "lazy", "sluggish", "brainless", "slow",
                "gullible", "obtuse", "dense", "dim", "dazed", "ridiculous", 
                "witless", "daft", "crazy", "vapid", "inane", "mundane", "hollow", 
                "vacuous", "boring", "insipid", "tedious", "monotonous", "weird", 
                "bizarre", "backward", "moronic", "ignorant", "scatterbrained", 
                "forgetful", "careless", "lethargic", "insolent", "indolent", 
                "loitering", "gross", "disgusting", "bland", "horrid", "unseemly",
                "revolting", "homely", "deformed", "disfigured", "offensive", 
                "cowardly", "weak", "villainous", "fearful", "monstrous", 
                "unattractive", "unpleasant", "nasty", "beastly", "snide", 
        ...
        case "praise":
            var praise = ["beautiful", "intelligent", "smart", "genius", 
                ...
                "fascinating", "interesting", "divine", "alluring", "ravishing", 
                "wonderful", "magnificient", "marvelous","dazzling", "cute", 
                "charming", "attractive", "nifty", "delightful", "superior", 
                "amiable", "gentle", "heroic", "courageous", "valiant", "brave",
                "noble", "daring", "fearless", "gallant", "adventurous", 
                "cool", "enthusiastic", "fierce", "awesome", "radical", "tubular", 
        ...
        default:
            ...
            "programming", "calculating", "formulating", "cyberpunk", "mechanical", 
    ...
    switch (y) {
        case "animals":
            var animals = ["flamingo", "hedgehog", "owl", "elephant", "pussycat", 
                ...
                "toucan", "raccoon", "vulture", "peacock", "goldfish", "rook", 
                "koala", "skunk", "goat", "rooster", "fox", "porcupine", "llama", 
                "grasshopper","gorilla", "monkey", "seahorse", "wombat", "wolf", 
                "giraffe", "badger", "lion", "mouse", "beetle", "cricket", 
                ...
                "buzzard", "vulture","rhino", "hippopotamus", "dolphin", "sparrow", 
                "beaver", "moose", "minnow", "otter", "bat", "mongoose", "swan", 
                "firefly", "platypus"
            ];
            return animals;
        ...
        case "profession":
            ...
            "surgeon", "clerk", "artist", "actor", "engineer", "mechanic",
                ...
                "mayor", "merchant", "detective", "investigator", "navigator", 
                "pilot", "priest", "cowboy", "stagehand", "soldier", 
        ...
        case "music":
            ...
            "orchestra", "piano", "trombone", "tuba", "opera", "drums",
                ...
                "woodwind", "saxophone", "bugle", "trumpet", "sousaphone", "cornet", 
                "stradivarius", "marimbas", "bells", "timpani", "bongos", "clarinet", 
        ...
        case "horror":
            ...
            "devil", "killer", "psycho", "ghost", "monster", "godzilla", "werewolf",
                "vampire", "demon", "graveyard", "zombie", "mummy", "curse", 
                "death", "grave", "tomb", "beast", "nightmare", "frankenstein", 
                "specter","poltergeist", "wraith", "corpse", "scream", "massacre", 
                "cannibal", "skull", "bones", "undertaker", "zombie", "creature",
        ...
        case "gross":
            ...
            "spit", "boil", "blister", "orifice", "secretion", "mucus", "phlegm",
        ...
        case "jewelry":
            var jewelry = ["earrings", "ring", "necklace", "pendant", "choker", 
                "brooch", "bracelet", "cameo", "charm", "bauble", "trinket", "jewelry",
        ...
        case "scifi":
            ...
            "phaser", "astronaut", "spaceman", "planet", "star", "galaxy",
                ...
                "mars", "quasar", "blackHole", "warpDrive", "laser", "orbit", "gears", 
                "molecule", "electron", "neutrino", "proton", "experiment", "photon", 
                "apparatus","universe", "gravity", "darkMatter", "constellation", 
                "circuit", "asteroid"
            ];
            return scifi;
        ...
        default:
            ...
            "rocket", "phaser", "astronaut", "spaceman", "planet", "star", "galaxy",
                "computer", "future", "timeMachine", "wormHole", "timeTraveler", 
                "scientist", "invention", "martian", "pluto", "jupiter", "saturn", 
                "mars", "quasar", "blackHole", "warpDrive", "laser", "orbit", "gears", 
                "molecule", "electron", "neutrino", "proton", "experiment", "photon", 
...
// These functions return a string of a random ingredient from each respective 
...
var resizePizzas = function(size) {
    ...
    function determineDx(elem, size) {
        ...
        // This code with MASSIVE help from GitHub user LacyJPR
        // See https://github.com/lacyjpr/optimization/blob/master/src/js/main.js 
        // This changes the size of the pizzas based on the slider position.
    ...
    function changePizzaSizes(size) {
        ...
        for (var i = 0; i < pizzaLength; i++) {
            //This code below assigns the width as a percentage-very handy!
    ...
    console.log("Time to resize pizzas: " + timeToResize[timeToResize.length - 1]
        .duration + "ms");
};
...
// User Timing API again. These measurements tell you how long it took to 
// generate the initial pizzas
...
function logAverageFrame(times) { // times is the array of User Timing 
    //measurements from updatePositions()
...
// found at: https://www.igvita.com/slides/2012/devtools-tips-and-tricks/jank-demo.html
// Moves the sliding background pizzas based on scroll position

// Gets all elements with class 'mover'- much more performant than 
// querySelectorAll, as was originally written. Declared in global scope 
// for performance reasons- doesn't need to be iterated over & over in loop. 
